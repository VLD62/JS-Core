...
describe("Check rgbToHexColor task", function () {
    describe("Test for output", function () {
    ...
    describe("Test for output", function () {
        it("should return FF9AFD for (255, 158, 170)", function () {
    ...
    describe("Test for output", function () {
        it("should return undefined for (3.14, 0, 0)", function () {
            expect(rgbToHexColor(3.14, 0, 0)).to.undefined;
        });
    });
    describe("Test for output", function () {
        it("should return undefined for (0, 3.14, 0)", function () {
            expect(rgbToHexColor(0, 3.14, 0)).to.undefined;
        });
    });
    describe("Test for output", function () {
        it("should return undefined for (0, 0, 3.14)", function () {
            expect(rgbToHexColor(0, 0, 3.14)).to.undefined;
        });
    });
    describe("Test for output", function () {
        it("should return undefined for (\"5\", [3], {8:9})", function () {
            expect(rgbToHexColor("5", [3], {8:9})).to.undefined;
        });
    });
    describe("Test for output", function () {
